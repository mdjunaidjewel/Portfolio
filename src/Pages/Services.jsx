...
export const Services = () => {
  return (
    <div>
      <section id="services" className=" w-11/12 mx-auto pt-10 sm:pt-16 pb-6 ">
        <h2 className="text-3xl font-bold text-center">
          My{" "}
          <span className="text-yellow-500 underline underline-offset-5">
            Services
          </span>
        </h2>
        <div className="p-8 grid sm:grid-cols-3 gap-5">
          <div className="group card-bg borde-2 border-[#323946] flex justify-center items-center flex-col p-5 rounded-md  hover:scale-101 duration-200 hover:border-amber-300 border-1 hover:text-blue-700 cursor-pointer shadow-md hover:shadow-amber-500 shadow-blue-400">
            <i className="bx bx-code-alt text-5xl text-blue-300 group-hover:text-yellow-400"></i>
            <h3 className="text-blue-300 font-semibold group-hover:text-yellow-300 text-2xl">
              Web Development
            </h3>
            <p  className=" card-Paragraph pt-2">
          ...
          <div className="group card-bg borde-2 border-[#323946] flex justify-center items-center flex-col p-5 rounded-md hover:scale-101 duration-200 hover:border-amber-300 border-1 hover:text-blue-700 cursor-pointer shadow-md hover:shadow-amber-500 shadow-blue-400">
            ...
            <p className="card-Paragraph py-2">
